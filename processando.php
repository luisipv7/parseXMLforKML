...
$kml[] = ' </Style>';
$kml[] = ' <Camera>';   
$kml[] = '<longitude>'.$xml->Document->Folder->Folder->Placemark->LookAt->longitude.'</longitude>';
$kml[] = '<latitude>'.$xml->Document->Folder->Folder->Placemark->LookAt->latitude.'</latitude>'  ;
